...
const getToDoEditedValues = () => ({
  title : form.titleToDo.value.trim(),
  description : form.description.value.trim() || "",
  dueDate : form.dueDate.value || "",
  priority : form.priority.value || "",
  checklist : form.checklist.checked,
});
...
export const editToDoCards = (projId, todoId) => {
